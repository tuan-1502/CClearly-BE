...
public class OrderService {
  ...
  private OrderResponse toResponse(Order o) {
    ...
    return OrderResponse.builder()
        ...
        .shippingPhone(o.getAddress() != null ? o.getAddress().getPhone() : (o.getUser() != null ? o.getUser().getPhoneNumber() : null))
        .recipientName(o.getAddress() != null ? o.getAddress().getName() : (o.getUser() != null ? o.getUser().getFullName() : null))
